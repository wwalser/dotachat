...
var ApiClient = function (appId, options) {
    ...
    var ApiClient = $ = function (apiKey) {
        ...
        this.params.language = options && options.language || conf.language;
        this.params.version = options && options.steamApiVersion || conf.steamApiVersion;
		this.accessor = options && options.accessor || 'result';
