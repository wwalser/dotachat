...
function Dota2Chat(fullMessage:string, templateRender:(x:string, y:templateData)=>string){
	var message = messageParameters(fullMessage);
	var respondWith = {
		"message": '',
		"color": "gray",
		"message_format": "html"
...
function messageParameters(message:string) {
